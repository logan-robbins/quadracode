"""Data models for the Quadracode Agent Registry service.

This contract is intentionally minimal to support a lightweight registry
with simple registration and discovery. Registration responses should not
return a separate model; the API simply returns a success acknowledgement.
"""
...
class AgentRegistrationRequest(BaseModel):
    """Payload sent by agents to register with the registry service."""
