...
def discover_test_commands(root: Path, *, include_e2e: bool = True) -> List[DiscoveredTestCommand]:
    """Infer the set of test commands worth running from workspace metadata."""
...
def execute_full_test_suite(
    *,
    ...
    """Run the discovered commands, capturing structured telemetry."""
...
def run_full_test_suite(
    ...
    """Execute all discovered unit/e2e tests and return structured telemetry."""
